            ...
            <div
                        ...
                        <div className="relative h-full">
                            <div className="absolute line0 border-t gray-border">
                                <div className="relative">
                                    <div className="absolute transform -translate-y-1/2 left-36">
                                        <a href="https://github.com/sombii" target="_blank" rel="noreferrer">
                                        <svg
                                    ...
                                    <div className="absolute">
                                        ...
                                        <svg
                                            className="h-8 w-8 absolute  transform -translate-y-1/2 left-20"
                                            fill="#fff"
                                            version="1.1"
                                            xmlns="http://www.w3.org/2000/svg"
                                            viewBox="0 0 512 512"
                ...
                <div className="mt-20 sm:mt-0 mb-10 text-white h1 font-bold text-right uppercase">
                    ...
                    <div className="overflow-hidden"><p className="heading head-ani-2"><span
                        className="outliner">React</span>Developer</p></div>
                    <div className="overflow-hidden"><p className="heading head-ani-1">From<span
                        className="outliner">Hetauda</span></p></div>
                </div>
            </div>
        </>
    )
